...
import AsmHelperPlugin.psi.NASMElementType;
import AsmHelperPlugin.psi.NASMTokenType;
import com.intellij.lang.ASTNode;
import com.intellij.psi.PsiElement;
import com.intellij.psi.tree.IElementType;
import gen.AsmHelperPlugin.psi.impl.*;

public interface NASMTypes {

  IElementType ADDRESS = new NASMElementType("ADDRESS");
  IElementType ASSIGN = new NASMElementType("ASSIGN");
  IElementType AVX_2_OP = new NASMElementType("AVX_2_OP");
  IElementType AVX_512_OP = new NASMElementType("AVX_512_OP");
  IElementType AVX_OP = new NASMElementType("AVX_OP");
  ...
  IElementType FPU_OP = new NASMElementType("FPU_OP");
  IElementType GENERAL_OP = new NASMElementType("GENERAL_OP");
  ...
  IElementType MMX_OP = new NASMElementType("MMX_OP");
  ...
  IElementType SSE_2_OP = new NASMElementType("SSE_2_OP");
  IElementType SSE_3_OP = new NASMElementType("SSE_3_OP");
  IElementType SSE_4_OP = new NASMElementType("SSE_4_OP");
  IElementType SSE_OP = new NASMElementType("SSE_OP");
  ...
  IElementType SYSTEM_OP = new NASMElementType("SYSTEM_OP");
  IElementType VIRTUALIZATION_OP = new NASMElementType("VIRTUALIZATION_OP");
  IElementType X_64_OP = new NASMElementType("X_64_OP");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == ADDRESS) {
      ...
      } else if (type == AVX_2_OP) {
        return new NASMAvx2OpImpl(node);
      } else if (type == AVX_512_OP) {
        return new NASMAvx512OpImpl(node);
      } else if (type == AVX_OP) {
        return new NASMAvxOpImpl(node);
        ...
        return new NASMFpuOpImpl(node);
      } else if (type == GENERAL_OP) {
        return new NASMGeneralOpImpl(node);
      ...
      } else if (type == SSE_2_OP) {
        return new NASMSse2OpImpl(node);
      } else if (type == SSE_3_OP) {
        return new NASMSse3OpImpl(node);
      } else if (type == SSE_4_OP) {
        return new NASMSse4OpImpl(node);
      } else if (type == SSE_OP) {
        return new NASMSseOpImpl(node);
      } else if (type == STR) {
      ...
      } else if (type == SYSTEM_OP) {
        return new NASMSystemOpImpl(node);
      } else if (type == VIRTUALIZATION_OP) {
        return new NASMVirtualizationOpImpl(node);
      } else if (type == X_64_OP) {
        return new NASMX64OpImpl(node);
      }
