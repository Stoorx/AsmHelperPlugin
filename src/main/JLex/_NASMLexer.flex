...
<YYINITIAL> {
  ...
  {INS_DATA_TRANS_MOV}        { return INS_DATA_TRANS_MOV; }
  {INS_DATA_TRANS_XCHG}       { return INS_DATA_TRANS_XCHG; }
  {INS_DATA_TRANS_OTHER}      { return INS_DATA_TRANS_OTHER; }
  {INS_DECIMAL_ARITH}         { return INS_DECIMAL_ARITH; }
  {INS_BINARY_ARITH}          { return INS_BINARY_ARITH; }
  {INS_BINARY_LOGICAL}        { return INS_BINARY_LOGICAL; }
  {INS_BINARY_ROTATE}         { return INS_BINARY_ROTATE; }
  {INS_BINARY_SET}            { return INS_BINARY_SET; }
  {INS_BINARY_OTHER}          { return INS_BINARY_OTHER; }
  {INS_CONTROL_TRANS}         { return INS_CONTROL_TRANS; }
  {INS_STRING_DATA}           { return INS_STRING_DATA; }
  {INS_INPUT_OUTPUT}          { return INS_INPUT_OUTPUT; }
  {INS_FLAG_CONTROL}          { return INS_FLAG_CONTROL; }
  {INS_SEG_REGS}              { return INS_SEG_REGS; }
  {INS_MISC_OTHER}            { return INS_MISC_OTHER; }
  {INS_RNG_RAND}              { return INS_RNG_RAND; }
  {INS_BIT_MANIPULATION}      { return INS_BIT_MANIPULATION; }
  {INS_SYSTEM}                { return INS_SYSTEM; }
  {INS_INTEL_VMX}             { return INS_INTEL_VMX; }
  {INS_AMD_SVM}               { return INS_AMD_SVM; }
  {INS_64_BIT}                { return INS_64_BIT; }
  {INS_FPU_DATA_TRANS}        { return INS_FPU_DATA_TRANS; }
  {INS_FPU_BASIC_ARITH}       { return INS_FPU_BASIC_ARITH; }
  {INS_FPU_COMPARISON}        { return INS_FPU_COMPARISON; }
  {INS_FPU_TRANSCEND}         { return INS_FPU_TRANSCEND; }
  {INS_FPU_LOAD}              { return INS_FPU_LOAD; }
  {INS_FPU_CONTROL}           { return INS_FPU_CONTROL; }
  {INS_FPU_STATE}             { return INS_FPU_STATE; }
  {INS_MMX_DATA_TRANS}        { return INS_MMX_DATA_TRANS; }
  {INS_MMX_CONVERSION}        { return INS_MMX_CONVERSION; }
  {INS_MMX_ARITH}             { return INS_MMX_ARITH; }
  {INS_MMX_COMPARISON}        { return INS_MMX_COMPARISON; }
  {INS_MMX_LOGICAL}           { return INS_MMX_LOGICAL; }
  {INS_MMX_ROTATE}            { return INS_MMX_ROTATE; }
  {INS_MMX_STATE}             { return INS_MMX_STATE; }
  {INS_SSE_DATA_TRANS}        { return INS_SSE_DATA_TRANS; }
  {INS_SSE_ARITH}             { return INS_SSE_ARITH; }
  {INS_SSE_COMPARISON}        { return INS_SSE_COMPARISON; }
  {INS_SSE_LOGICAL}           { return INS_SSE_LOGICAL; }
  {INS_SSE_OTHER}             { return INS_SSE_OTHER; }
  {INS_SSE_CONVERSION}        { return INS_SSE_CONVERSION; }
  {INS_SSE_STATE}             { return INS_SSE_STATE; }
  {INS_SSE_SIMD_INT}          { return INS_SSE_SIMD_INT; }
  {INS_SSE_CACHE_CTRL}        { return INS_SSE_CACHE_CTRL; }
  {INS_SSE_PREFETCH}          { return INS_SSE_PREFETCH; }
  {INS_SSE2_DATA_TRANS}       { return INS_SSE2_DATA_TRANS; }
  {INS_SSE2_ARITH}            { return INS_SSE2_ARITH; }
  {INS_SSE2_LOGICAL}          { return INS_SSE2_LOGICAL; }
  {INS_SSE2_COMPARISON}       { return INS_SSE2_COMPARISON; }
  {INS_SSE2_OTHER}            { return INS_SSE2_OTHER; }
  {INS_SSE2_CONVERSION}       { return INS_SSE2_CONVERSION; }
  {INS_SSE2_SIMD_INT}         { return INS_SSE2_SIMD_INT; }
  {INS_SSE2_CACHE_CTRL}       { return INS_SSE2_CACHE_CTRL; }
  {INS_SSE3_GENERAL}          { return INS_SSE3_GENERAL; }
  {INS_SSE3_ARITH}            { return INS_SSE3_ARITH; }
  {INS_SSE3_OTHER}            { return INS_SSE3_OTHER; }
  {INS_SSE4_ARITH}            { return INS_SSE4_ARITH; }
  {INS_SSE4_DATA_TRANS}       { return INS_SSE4_DATA_TRANS; }
  {INS_SSE4_BLEND}            { return INS_SSE4_BLEND; }
  {INS_SSE4_PACKED_INT}       { return INS_SSE4_PACKED_INT; }
  {INS_SSE4_PACKED_FP}        { return INS_SSE4_PACKED_FP; }
  {INS_SSE4_INS_EXT}          { return INS_SSE4_INS_EXT; }
  {INS_SSE4_CONVERSION}       { return INS_SSE4_CONVERSION; }
  {INS_SSE4_OTHER}            { return INS_SSE4_OTHER; }
  {INS_AVX_GENERAL}           { return INS_AVX_GENERAL; }
  {INS_AVX_AES}               { return INS_AVX_AES; }
  {INS_AVX_COMPARISON}        { return INS_AVX_COMPARISON; }
  {INS_AVX_CONVERSION}        { return INS_AVX_CONVERSION; }
  {INS_AVX_LOGICAL}           { return INS_AVX_LOGICAL; }
  {INS_AVX_MOV}               { return INS_AVX_MOV; }
  {INS_AVX_ARITH}             { return INS_AVX_ARITH; }
  {INS_AVX_PACKED}            { return INS_AVX_PACKED; }
  {INS_AVX_BLEND}             { return INS_AVX_BLEND; }
  {INS_AVX_CACHE}             { return INS_AVX_CACHE; }
  {INS_AVX_FMA3}              { return INS_AVX_FMA3; }
  {INS_AVX_OTHER}             { return INS_AVX_OTHER; }
  {INS_AVX2_SIMD}             { return INS_AVX2_SIMD; }
  {INS_AVX2_BROADCAST}        { return INS_AVX2_BROADCAST; }
  {INS_AVX2_BLEND}            { return INS_AVX2_BLEND; }
  {INS_AVX2_GATHER}           { return INS_AVX2_GATHER; }
  {INS_AVX512_BLEND}          { return INS_AVX512_BLEND; }
  {INS_AVX512_BROADCAST}      { return INS_AVX512_BROADCAST; }
  {INS_AVX512_MOV}            { return INS_AVX512_MOV; }
  {INS_AVX512_COMPRESS}       { return INS_AVX512_COMPRESS; }
  {INS_AVX512_CONV}           { return INS_AVX512_CONV; }
  {INS_AVX512_MATH}           { return INS_AVX512_MATH; }
  {INS_AVX512_LOGICAL}        { return INS_AVX512_LOGICAL; }
  {INS_AVX512_COMPARE}        { return INS_AVX512_COMPARE; }
  {INS_AVX512_PACKED}         { return INS_AVX512_PACKED; }
